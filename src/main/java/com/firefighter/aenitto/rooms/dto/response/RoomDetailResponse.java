...
public class RoomDetailResponse {
	...
	public static RoomDetailResponse buildProcessingResponse(Room room, Relation relationManittee,
		Relation relationManitto, MemberRoom memberRoom, boolean didView, Mission mission, int messageCount) {
		return RoomDetailResponse.builder()
			.room(RoomDetail.of(room))
	...
	public static RoomDetailResponse buildPostResponse(Room room, Relation relation, MemberRoom memberRoom,
		int messageCount) {
		return RoomDetailResponse.builder()
			.room(RoomDetail.of(room))
			.admin(memberRoom.isAdmin())
