...
public class MemberRoomTest {
    ...
    @Autowired MissionRepositoryImpl missionRepository;
    ...
    void addIndividualMission_success() {
        ...
        assertThat(findMemberRoom.getIndividualMissions().get(0).getMission().getContent()).isEqualTo(mission.getContent());
    }
